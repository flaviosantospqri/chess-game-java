...
public class ChessMath {
    ...
    public ChessPiece performChessMove(ChessPostion sourcePosition, ChessPostion targetPosition){
        ...
        if(movedPiece instanceof Pawn){
            if(movedPiece.getColor() == EnumColor.WHITE && target.getRow() == 0 || movedPiece.getColor() == EnumColor.BLACK && target.getRow() == 7 ){
    ...
    private ChessPiece newPiece(String type, EnumColor color){
